...
import wedding from '../../assets/water/self/2G5A0777.JPG';
    ...
    return (
      <div>
        <div className='about-blurb'>
          <img className='about-img float-left' src={family} alt='Ben with family'/>
          <div className='about-container'>
            <h2 className='officiating-title about-title'>About Me</h2>
            ...
            <img className='about-img about-img-2 float-right' src={wedding} alt='Ben and wife on wedding day'/>
